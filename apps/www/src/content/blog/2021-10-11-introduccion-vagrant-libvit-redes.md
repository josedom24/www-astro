...
slug: 2021/10/introduccion-vagrant-libvirt-redes
tags:
  - Vagrant
  - libvirt
  - kvm
...
![redes](/pledin/assets/2021/10/vagrant-kvm2.png)

En la entrada anterior: [Introducción al uso de vagrant + libvirt + QEMU/KVM](https://www.josedomingo.org/pledin/2021/09/introduccion-vagrant-libvirt/) se hizo una introducción al uso de Vagrant para crear máquina virtuales usando libvirt y KVM. En esta entrada nos vamos a detener en los aspectos más interesantes para la definición de redes virtuales.
...
Al iniciar el escenario, se crea una red llamada `vagrant-private-dhcp` con la siguiente definición:
...
En esta entrada hemos hecho una introducción a la definición de redes virtuales usando vagrant y libvirt/kvm. Como simpre si quieres seguir profundizando en el tema te sugiero la documentación de redes de libvirt/kvm: [Networking](https://wiki.libvirt.org/page/Networking) y la documentación oficial del plugin de vagrant: [vagrant-libvirt](https://github.com/vagrant-libvirt/vagrant-libvirt).