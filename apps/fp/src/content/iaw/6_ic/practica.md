...
Partimos del pipeline que hemos desarrollado en el [Taller 3: Integración continua de aplicación django (Test)](taller3), donde hemos automatizado el test de la aplicación.
...
Por lo tanto tienes que estudiar el apartado [Ejecución de un pipeline en varios runner](jenkins/runner) para ejecutar el pipeline en dos runner:
