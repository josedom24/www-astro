...
1. Utilizar las órdenes `docker save` / `docker load`. En este caso la distribución se producirá a partir de un fichero.
2. Utilizar la pareja de órdenes `docker push` / `docker pull`. En este caso la distribución se producirá a través de DockerHub.
