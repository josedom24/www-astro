...
* Cuando creamos un contenedor a partir de una imagen:
    ...
    * Añade **encima** una **capa de escritura** exclusiva del contenedor de escritura y lectura donde se van guardando las modificaciones que realiza el contenedor en el sistema de archivos (**parecido a la clonación ligada en las máquinas virtuales**). Resultado final:
